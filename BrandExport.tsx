  ...
  const assetCategories = [
    {
      ...
      items: [
        ...
        { id: 'logomark-svg', name: 'Ampersand Mark (SVG)', size: '8 KB', format: 'Vector' },
        { id: 'logoicon-svg', name: 'Interlocking C (SVG)', size: '6 KB', format: 'Vector' },
        { id: 'favicon-ico', name: 'Favicon (ICO)', size: '4 KB', format: 'ICO' },
        { id: 'favicon-svg', name: 'Favicon (SVG)', size: '2 KB', format: 'Vector' },
