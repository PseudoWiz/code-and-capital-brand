...
import { Logo, LogoMark, LogoIcon, LogoMinimal } from './Logo';
    ...
    <section className="space-y-16">
      ...
      <div>
        ...
        <p className="text-[#27272A] mb-8 leading-relaxed max-w-2xl">
          For small spaces, social media, and app icons, we have simplified logomarks that maintain 
          brand recognition while working at any size.
        </p>

        <div className="grid md:grid-cols-3 gap-1 bg-[#09090B] p-1">
          {/* Square Logomark */}
          <div className="bg-white p-12">
            <div className="flex justify-center mb-6">
              <LogoMark variant="indigo" size={120} />
            </div>
            <p className="text-xs font-mono text-[#71717A] text-center mb-2">SQUARE LOGOMARK</p>
            <p className="text-xs text-[#71717A] text-center">Social media, favicons</p>
          </div>
          ...
          <div className="bg-white p-12">
            ...
            <p className="text-xs font-mono text-[#71717A] text-center mb-2">GEOMETRIC ICON</p>
            <p className="text-xs text-[#71717A] text-center">App icons, brand marks</p>
          </div>
          ...
          <div className="bg-white p-12">
            ...
            <p className="text-xs font-mono text-[#71717A] text-center mb-2 mt-8">MINIMAL MARK</p>
            <p className="text-xs text-[#71717A] text-center">Watermarks, small UI</p>
          </div>
        </div>
      </div>
